...
cache_dir <- ".secrets/.cache/gargle"
dir.create(cache_dir, recursive = TRUE, showWarnings = FALSE)
token_file <- file.path(cache_dir, "token.rds")
writeBin(decoded_cert, token_file)

# Authenticate with the cached token
gs4_auth(cache = cache_dir)
drive_auth(cache = cache_dir)
