    ...
    print(nrow(sheet_master))
     if(nrow(sheet_master) != 0) {
      master <- bind_rows(sheet_master, master)
       ...
       no_rows_sheets <- c(no_rows_sheets, new_files$id[i])
       next
      }
  },
  error = function(e) {
...
fwrite(problem_sheets,  "./_data/problem_sheets.csv")
...
These sheets are empty: `r print(no_rows)`
These sheets are giving us problems: `r print(problems)`
